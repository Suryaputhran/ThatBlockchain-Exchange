...
contract DecentralizedExchange {
    ...
    function withdrawMATIC(uint256 _amount) public {
        ...
        emit Withdraw(address(0), msg.sender, _amount, address(this).balance);
    }
    ...
    function makeOrder(address _tokenGet, uint256 _amountGet, address _tokenGive, uint256 _amountGive) public {
        require(balanceOfToken(_tokenGive, msg.sender) >= _amountGive, "Insufficient balance.");
        orderCount++;
    ...
    function cancelOrder(uint256 _id) public {
        ...
        require(_order.user == msg.sender, "Access Denied: You are not authorized to cancel this order");
