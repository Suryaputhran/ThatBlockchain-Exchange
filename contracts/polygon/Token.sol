...
contract Token {
    ...
    uint256 public totalSupply; // Total supply in MATIC tokens
    ...
    constructor(string memory _name, string memory _symbol, uint256 _decimals, uint256 _totalSupply) {
        ...
        symbol = _symbol;
        decimals = _decimals;
        totalSupply = _totalSupply * 10**_decimals; // Total supply in MATIC tokens

        // Allocate the total supply to the contract deployer's address
